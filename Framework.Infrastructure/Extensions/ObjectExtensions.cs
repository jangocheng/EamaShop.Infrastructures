...
namespace System
{
    ...
    {
        /// <summary>
        /// 将对象转换为Json字符串，其中不包含类型元数据，如果对象为 null，则返回null
        /// </summary>
        /// <param name="obj">需要序列化的对象</param>
        /// <returns>如果需要序列化的对象为null。则返回null，否则返回序列化后的json字符串</returns>
        ...
        /// <summary>
        /// 将对象转换为Json字符串，其中包含类型元数据，如果对象为 null，则返回null
        /// </summary>
        /// <typeparam name="T">元数据类型，通常是接口/抽象类型</typeparam>
        /// <param name="obj">需要序列化的对象</param>
        /// <returns>如果需要序列化的对象为null。则返回null，否则返回序列化后的json字符串</returns>
        public static string SerializeJsonWithType<T>(this T obj) =>
            SerializeJsonWithType(obj, typeof(T));
        /// <summary>
        /// 将对象转换为Json字符串，其中包含类型元数据，如果对象为 null，则返回null
        /// </summary>
        /// <param name="obj">需要序列化的对象</param>
        ...
        /// <returns>如果需要序列化的对象为null。则返回null，否则返回序列化后的json字符串</returns>
        public static string SerializeJsonWithType(this object obj, Type modelType) =>
            obj == null ? null : JsonConvert.SerializeObject(obj, modelType, Setting);
        /// <summary>
        ...
        /// <summary>
        /// 将json字符串的所有值填充到指定的对象中 如果json为空字符串 则不填充原样返回需要填充的对象
        /// </summary>
        ...
        /// <returns>md5密文字符串</returns>
        /// <exception cref="ArgumentNullException">需要加密的字符串为null时引发的异常</exception>
