...
namespace Framework.Infrastructure
{
    ...
    public interface IRespository<TEntity, TListModel, TCondtion> : IRespository<TEntity, TListModel, IPageEnumerable<TListModel>, TCondtion, long>
